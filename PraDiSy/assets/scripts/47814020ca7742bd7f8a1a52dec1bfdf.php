...
/* ./ls_logo_svg.twig */
class __TwigTemplate_f87c4ddda09b4b0d71838a5284cc4fa8 extends Template
{
    private $source;
    private $macros = [];
...
";*/
    ...
    // Line 1
    echo '<svg class="ls-logo"  viewBox="0 0 400 148" fill="none" xmlns="http://www.w3.org/2000/svg">';

    // Der Inhalt der neuen SVG-Datei wird hier eingefügt
    echo <<<SVG
            <svg
        version="1.1"
        id="svg1"
    ...
    {
        return new Source("", "./ls_logo_svg.twig", "/var/www/html/themes/survey/fruity_twentythree/views/ls_logo_svg.twig");
    }
