...
# API-Konfiguration
LIMESURVEY_URL = "https://avis-formosa.limesurvey.net/admin/remotecontrol"
USERNAME = "avis_formosa"  # Ersetzen Sie dies durch Ihren Admin-Benutzernamen
PASSWORD = "hukpep-naxsuz-7zacTu"  # Ersetzen Sie dies durch Ihr Passwort
